...
// Reusable interface for card data
export interface BentoItem {
    icon?: React.ElementType;
    title: string;
    description: string;
    // Optional color override if needed, otherwise uses theme
    color?: string;
}
...
const GlobalSpotlight: React.FC<{
    ...
    glowColor = DEFAULT_GLOW_COLOR
      ...
      position: fixed;
      width: ${spotlightRadius * 4}px;
      height: ${spotlightRadius * 4}px;
      border-radius: 50%;
      pointer-events: none;
                    ...
                    const CardContent = (
                        <>
                            <div className="magic-bento-card__header">
                                {item.icon && (
                                    <div className="magic-bento-card__icon-container">
                                        <item.icon className="magic-bento-card__icon" />
                                    </div>
                                )}
                            </div>
