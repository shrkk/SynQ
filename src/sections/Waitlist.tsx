...
export const Waitlist = () => {
    return (
        <section id="waitlist" className="py-32 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent to-synq-accent-violet/5 pointer-events-none" />
            ...
            <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
                ...
                <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
                    <input
                        ...
                        className="flex-1 bg-white/5 border border-synq-border rounded-lg px-4 py-3 text-white placeholder-synq-text-muted focus:outline-none focus:border-synq-accent-cyan transition-colors"
                    />
                ...
                <p className="mt-4 text-xs text-synq-text-muted">
